# HW_Module18
Добавила возможность сохранять в файле информацию о зарегистрированных пользователях в деструкторе чата ~Chat() и загружать эту информацию из файла в конструкторе чата Chat().
Добавила возможность сохранять в файле сообщения при их создании (sendMessage) и загружать эту информацию из файла в конструкторе чата Chat().
